...
MySQL - 5.6.25 : Database - itmuch_platform
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`itmuch_platform` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `f_office`(`id`,`parent_id`,`name`,`sort`,`area_id`,`code`,`type`,`address`,`zip_code`,`master`,`phone`,`fax`,`email`,`status`,`create_id`,`create_time`,`update_id`,`update_time`,`remark`,`del_flag`) values (1,0,'总公司',0,1,'0001',1,'','','','','','',1,1,'2015-09-02 09:45:25',0,'0000-00-00 00:00:00','',0);
...
insert  into `f_role`(`id`,`office_id`,`name`,`enname`,`role_type`,`sys_flag`,`status`,`create_id`,`create_time`,`update_id`,`update_time`,`remark`,`del_flag`) values (1,1,'超级管理员','su',1,0,0,1,'2015-09-02 09:46:16',0,'0000-00-00 00:00:00','',0),(2,1,'无权限的用户测试','test',2,0,0,6,'2015-09-02 10:57:40',0,'0000-00-00 00:00:00','',0);
...
insert  into `f_role_menu`(`role_id`,`menu_id`) values (1,1),(1,2),(1,3),(1,10),(1,11),(1,12),(1,13),(1,14),(1,20),(1,21),(1,22),(1,23),(1,24),(1,30),(1,31),(1,32),(1,33),(1,34),(1,40),(1,41),(1,42),(1,43),(1,44),(1,50),(1,51),(1,52),(1,53),(1,54),(1,60),(1,61),(1,62),(1,63),(1,64),(1,70),(1,71),(1,72),(1,73),(1,100),(1,101);
...
insert  into `f_user`(`id`,`company_id`,`office_id`,`username`,`password`,`salt`,`name`,`email`,`phone`,`mobile`,`user_type`,`photo`,`last_ip`,`last_time`,`status`,`create_id`,`create_time`,`update_id`,`update_time`,`remark`,`del_flag`) values (1,0,0,'admin','1a6dc0b974ebf951d684453cb99267aa','fbc5d00a625883c0','admin','itmuch0000@126.com','15151816012','15151816012',1,'','','0000-00-00 00:00:00',0,0,'0000-00-00 00:00:00',1,'2015-09-02 12:32:15','',0),(6,2,2,'eacdy','cf40fde8ebefd750afcd111c0e39ecff','78777995e30d8e48','eacdy','eacdy0000@126.com','15850770072','15850770072',1,'','','0000-00-00 00:00:00',0,1,'2015-08-20 16:14:54',1,'2015-09-02 12:32:52','test',0);
...
insert  into `f_user_role`(`user_id`,`role_id`) values (1,1),(1,2),(6,1),(6,2);
