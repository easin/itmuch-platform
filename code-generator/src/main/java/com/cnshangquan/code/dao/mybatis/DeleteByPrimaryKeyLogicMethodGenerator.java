 ...
 * 
 */
public class DeleteByPrimaryKeyLogicMethodGenerator extends AbstractJavaMapperMethodGenerator {

	public DeleteByPrimaryKeyLogicMethodGenerator() {
		super();
	}
	...
	public void addInterfaceElements(Interface interfaze) {
		...
		method.setName(this.introspectedTable.getDeleteByPrimaryKeyLogicStatementId());
